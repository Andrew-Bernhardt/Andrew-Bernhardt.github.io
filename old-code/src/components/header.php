<header>
        ...
        <div class="download-resume-container">
            <a class="download-resume-button" href="../data/Andrew Bernhardt Resume.pdf" target="_blank"><img src="../images/downloadbtn.png" class="download-resume-button" alt="RESUME"></a>
        </div>
    </header>
